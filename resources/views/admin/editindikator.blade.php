    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header"><b>Edit Indikator </b></div>
                <form action="{{url('admin/post-editindikator')}}" method="POST" id="regForm" class="form-horizontal">
                  <div class="card-body">
                   {{ csrf_field() }}
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-1">
                                <input class="form-control form-control-sm " id="kode" type="text"  name="kode" value="{{ $ind->kode }}"   />
                            </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                      <input class="form-control form-control-sm" id="nama" type="text" name="nama" placeholder="Nama Indikator" value="{{ $ind->nama }}" required />
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input class="form-control form-control-sm" id="sumber" type="text"   name="sumber" placeholder="Masukan Sumber Data" value="{{ $ind->sumber }}" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                          <input class="form-control form-control-sm" id="satuan" type="text"  name="satuan" placeholder="Masukan Satuan" value="{{ $ind->satuan }}" />
