    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header"><b>Add Artikel</b></div>
                <form action="{{url('admin/post-addartikel')}}" method="POST" id="regForm" class="form-horizontal">
                <div class="card-body">
                   {{ csrf_field() }}
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                      <input class="form-control form-control-sm " id="judul" type="text" name="judul" placeholder="judul artikel" />
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                          <select class="form-control form-control-sm select2" name="jenis" id="jenis"  required>
                              ...
                              <option value="1" >Artikel Umum</option>
                              <option value="2" >Forum Anak </option>
                          </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label" for="desk">Teaser/Deskripsi Singkat</label>
                      <div class="col-sm-9">
                        <input class="form-control form-control-sm " id="teaser" type="text" name="teaser" placeholder="deskripsi singkat " />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <textarea name="fullteks" id="fullteks" cols="100" rows="30" class="form-control form-control-sm isi"></textarea>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-3 col-form-label">Upload Foto/Gambar </label>
                            ...
                            <div class="col-sm-5">
                            File : <span id="ressnamafilefoto"></span>
                            </div>
                    </div>
                    @if($userlev==1) 
                    <hr> 
