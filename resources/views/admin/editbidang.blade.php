    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header"><b>Edit Bidang</b></div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <select class="form-control form-control-sm select2" name="id_jenis" id="id_jenis"  required>
                            ...
                            ?>
                            @foreach ($jenis as $pd)
                                <option value="{{ $pd->id }}" @if($pd->id==$bid->id_jenis) selected @endif >  {{ $pd->id }}. {{ $pd->namajenis }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-2">
                  <input class="form-control form-control-sm " id="alias" type="text" name="alias" value="{{ $bid->alias }}" readonly />
                    @if ($errors->has('alias'))
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-5">
                      <input class="form-control form-control-sm @error('namabidang') is-invalid @enderror" id="namabidang" type="text" name="namabidang" value="{{ $bid->namabidang }}" />
                ...
                <div class="card-footer"> 
                    ...
                    <input type="hidden" id="idna" name="idna" value="{{ $bid->id }}">
                </div>						
                </form>
            </div>
        </div>
