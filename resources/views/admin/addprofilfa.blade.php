    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header"><b>Add Profil FA</b></div>
                <form action="{{url('admin/post-addprofilfa')}}" method="POST" id="regForm" class="form-horizontal">
                <div class="card-body">
                   {{ csrf_field() }}
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                      <input class="form-control form-control-sm " id="judul" type="text" name="judul" placeholder="judul profil" />
